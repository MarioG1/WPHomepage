                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo number_format($wphist->get_cost(time()-(3600*24), time())/100,4,',','.')?></div>
                            <div>Kosten 24h </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-green">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo number_format($wphist->get_pow(time()-(3600*24), time()),2,',','.')?>kWh</div>
            ...
            <div class="panel panel-red">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo number_format($pwcost->get_avg_cost(time()-(3600*24), time())/100,4,',','.')?></div>
